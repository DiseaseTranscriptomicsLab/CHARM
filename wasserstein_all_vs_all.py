...
OUT_INC = os.path.expanduser(
    "~/Projects/CHARM/intermediary_files/Wasserstein_oddsratinc.csv"
)

OUT_DEC = os.path.expanduser(
    "~/Projects/CHARM/intermediary_files/Wasserstein_oddsratdec.csv"
)
...
def wasserstein_worker(args):
    ...
    dist = wasserstein_distance(x[mask], y[mask])
...
def run_all_pairs(mat, meta, outfile):
    ...
    with open(outfile, "w") as f:
        f.write("RBP1,Target1,dPSI1,RBP2,Target2,dPSI2,Wasserstein\n")
...
if __name__ == "__main__":
    ...
    print("✅ All Wasserstein comparisons completed.")
