...
build_bindingvalues_list <- function(
  ...
  for (folder in folder_names) {
    ...
    matches <- fs::dir_ls(folder_path, regexp = "BindingValues_IR_HEPG2\\.txt$", type = "file")
...
saveRDS(CharmObj_bindingvalues_nested, "~/Projects/CHARM/data/Binding_IR_HEPG2.RDS")
